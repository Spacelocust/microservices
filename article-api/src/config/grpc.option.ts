...
import { ARTICLE_V1ALPHA_PACKAGE_NAME } from 'src/stubs/article/v1alpha/service';

export default (cs: ConfigService) =>
  addReflectionToGrpcConfig({
    transport: Transport.GRPC,
    options: {
      package: ARTICLE_V1ALPHA_PACKAGE_NAME,
      ...
      protoPath: [join(__dirname, '../proto/article/v1alpha/service.proto')],
    },
  } as GrpcOptions);
