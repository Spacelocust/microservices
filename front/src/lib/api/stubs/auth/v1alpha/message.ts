...
export interface RefreshTokenResponse {
    ...
    jwt: string;
    /**
     * @generated from protobuf field: user.v1alpha.User user = 3;
     */
    user?: User;
}
/**
...
export interface ValidateResponse {
    ...
    user?: User;
    /**
     * @generated from protobuf field: bool internal = 3;
     */
    internal: boolean;
}
...
class ValidateResponse$Type extends MessageType<ValidateResponse> {
    constructor() {
        super("auth.v1alpha.ValidateResponse", [
            ...
            { no: 3, name: "internal", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value?: PartialMessage<ValidateResponse>): ValidateResponse {
        const message = { ok: false, internal: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryWrite(message: ValidateResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.internal !== false)
            writer.tag(3, WireType.Varint).bool(message.internal);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
